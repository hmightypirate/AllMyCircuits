...
#define SONG_VEL_MACGYVER 160
    int notes_pitch_MACGYVER[SONG_LEN_MACGYVER] = {
        C6, C6, C6, C6, C6, C6, B5, FX5, A5, R, G5, C6, C6, R, B5, A5, B5, A5, G5, R, E6, A5, R, B5, R, C6, B5, A5, C6};
    int notes_duration_MACGYVER[SONG_LEN_MACGYVER] = {
...
#define SONG_VEL_UNDER_THE_SEA 200
    int notes_pitch_UNDER_THE_SEA[SONG_LEN_UNDER_THE_SEA] = {
    ...
    int notes_duration_UNDER_THE_SEA[SONG_LEN_UNDER_THE_SEA] = {
...
#define SONG_VEL_BATMAN 180
    int notes_pitch_BATMAN[SONG_LEN_BATMAN] = {
        B5, B5, AX5, AX5, A5, A5, AX5, AX5, B5, B5, AX5, AX5, A5, A5, AX5, AX5, B5, R, B5};
    int notes_duration_BATMAN[SONG_LEN_BATMAN] = {
...
#define SONG_VEL_TEARS_IN_HEAVEN 112
    int notes_pitch_TEARS_IN_HEAVEN[SONG_LEN_TEARS_IN_HEAVEN] = {
        R, B5, G5, D6, D6, B5, A5, G5, R, R, C6, C6, B5, A5, G5, B5, A5};
    int notes_duration_TEARS_IN_HEAVEN[SONG_LEN_TEARS_IN_HEAVEN] = {
...
#define SONG_VEL_AADAMS 160
    int notes_pitch_AADAMS[SONG_LEN_AADAMS] = {
    ...
    int notes_duration_AADAMS[SONG_LEN_AADAMS] = {
...
#define SONG_VEL_DRNO 112
    int notes_pitch_DRNO[SONG_LEN_DRNO] = {
    ...
    int notes_duration_DRNO[SONG_LEN_DRNO] = {
...
#define SONG_VEL_BA_BA 100
    int notes_pitch_BA_BA[SONG_LEN_BA_BA] = {
        C5, C5, G5, G5, A5, B5, C6, A5, G5, R, F5, F5, E5, E5, D5, D5, C5};
    int notes_duration_BA_BA[SONG_LEN_BA_BA] = {
...
#define SONG_VEL_GEORGIA_ON_MY_MIND 63
    int notes_pitch_GEORGIA_ON_MY_MIND[SONG_LEN_GEORGIA_ON_MY_MIND] = {
        E5, G5, R, E5, D5, R, R, E5, A5, E5, D5, C5, D5, E5, G5, B5, A5, F5, F5, E5, E5, C5};
    int notes_duration_GEORGIA_ON_MY_MIND[SONG_LEN_GEORGIA_ON_MY_MIND] = {
...
#define SONG_VEL_MISSIONIMPOSSI 180
    int notes_pitch_MISSIONIMPOSSI[SONG_LEN_MISSIONIMPOSSI] = {
        DX6, C6, G5, DX6, C6, FX5, DX6, C6, F5, DX5, F5, R, GX5, G5, FX6, GX5, G5, F6, GX5, G5, E6, DX6, D6, R};
    int notes_duration_MISSIONIMPOSSI[SONG_LEN_MISSIONIMPOSSI] = {
...
#define SONG_VEL_BEETHOVEN 160
    int notes_pitch_BEETHOVEN[SONG_LEN_BEETHOVEN] = {
        C5, E5, C5, G5, C5, C6, B5, A5, G5, A5, G5, F5, E5, F5, E5, D5, C5, E5, G5, E5, C6, G5};
    int notes_duration_BEETHOVEN[SONG_LEN_BEETHOVEN] = {
...
#define SONG_VEL_FLNTSTN 200
    int notes_pitch_FLNTSTN[SONG_LEN_FLNTSTN] = {
    ...
    int notes_duration_FLNTSTN[SONG_LEN_FLNTSTN] = {
...
#define SONG_VEL_SUPERMAN 200
    int notes_pitch_SUPERMAN[SONG_LEN_SUPERMAN] = {
    ...
    int notes_duration_SUPERMAN[SONG_LEN_SUPERMAN] = {
...
#define SONG_VEL_GREENDAY 50
    int notes_pitch_GREENDAY[SONG_LEN_GREENDAY] = {
    ...
    int notes_duration_GREENDAY[SONG_LEN_GREENDAY] = {
...
#define SONG_VEL_DON_T_WANNA_MISS_A_THING 125
    int notes_pitch_DON_T_WANNA_MISS_A_THING[SONG_LEN_DON_T_WANNA_MISS_A_THING] = {
        R, A5, R, A5, R, A5, R, A5, G5, R, G5, R, R, R, G5, R, G5, R, G5, G5, R, C6, AX5, R, A5, G5, F5, G5, D5, F5, R, F5, R, C5, C5, R, A5, G5, F5, R, F5, R, C5, R, G5, F5};
    int notes_duration_DON_T_WANNA_MISS_A_THING[SONG_LEN_DON_T_WANNA_MISS_A_THING] = {
...
#define SONG_VEL_GIRLFROMIPANE 160
    int notes_pitch_GIRLFROMIPANE[SONG_LEN_GIRLFROMIPANE] = {
        G5, E5, E5, D5, G5, E5, E5, E5, D5, G5, E5, E5, D5, G5, G5, E5, E5, E5, D5, F5, D5, D5, D5, C5, E5, C5, C5, C5, AX4, C5};
    int notes_duration_GIRLFROMIPANE[SONG_LEN_GIRLFROMIPANE] = {
...
#define SONG_VEL_KNIGHTRIDER 125
    int notes_pitch_KNIGHTRIDER[SONG_LEN_KNIGHTRIDER] = {
...
#define SONG_VEL_90210 140
    ...
    int notes_duration_90210[SONG_LEN_90210] = {
...
#define SONG_VEL_HALLOWEEN 180
    int notes_pitch_HALLOWEEN[SONG_LEN_HALLOWEEN] = {
    ...
    int notes_duration_HALLOWEEN[SONG_LEN_HALLOWEEN] = {
...
#define SONG_VEL_CASTLE_ON_A_CLOUD 90
    int notes_pitch_CASTLE_ON_A_CLOUD[SONG_LEN_CASTLE_ON_A_CLOUD] = {
        A5, B5, C6, B5, A5, A5, GX5, A5, R, A5, B5, C6, B5, A5, G5, F5, E5, R, D5, E5, F5, E5, A5, B5, C6, A5, R, D5, E5, F5, E5, D5, C5, B5, A5};
    int notes_duration_CASTLE_ON_A_CLOUD[SONG_LEN_CASTLE_ON_A_CLOUD] = {
...
#define SONG_VEL_IMPERIAL 112
    int notes_pitch_IMPERIAL[SONG_LEN_IMPERIAL] = {
    ...
    int notes_duration_IMPERIAL[SONG_LEN_IMPERIAL] = {
...
#define SONG_VEL_THINK_PINK 70
    int notes_pitch_THINK_PINK[SONG_LEN_THINK_PINK] = {
    ...
    int notes_duration_THINK_PINK[SONG_LEN_THINK_PINK] = {
...
#define SONG_VEL_FIGARO 250
    int notes_pitch_FIGARO[SONG_LEN_FIGARO] = {
    ...
    int notes_duration_FIGARO[SONG_LEN_FIGARO] = {
...
#define SONG_VEL_MORE_THAN_WORDS 90
    int notes_pitch_MORE_THAN_WORDS[SONG_LEN_MORE_THAN_WORDS] = {
        R, E5, G5, G5, E5, A5, G5, G5, R, G5, G5, A5, G5, G5, G5, G5, A5, G5, F5, F5, F5, G5};
    int notes_duration_MORE_THAN_WORDS[SONG_LEN_MORE_THAN_WORDS] = {
...
#define SONG_VEL_SW_END 225
    int notes_pitch_SW_END[SONG_LEN_SW_END] = {
    ...
    int notes_duration_SW_END[SONG_LEN_SW_END] = {
...
#define SONG_VEL_STAIRWAY 63
    int notes_pitch_STAIRWAY[SONG_LEN_STAIRWAY] = {
        A6, C6, E6, A6, B6, E6, C6, B6, C7, E6, C6, C7, FX6, D6, A6, FX6, E6, C6, A6, C6, E6, C6, A5, G5, G5, A5, A5};
    int notes_duration_STAIRWAY[SONG_LEN_STAIRWAY] = {
...
#define SONG_VEL_BEATLES_LET_IT_BE 100
    int notes_pitch_BEATLES_LET_IT_BE[SONG_LEN_BEATLES_LET_IT_BE] = {
        E6, D6, C6, E6, G6, A6, G6, G6, G6, E6, D6, C6, A5, G5, E6, R, E6, E6, F6, E6, E6, D6, R, E6, D6, D6, C6};
    int notes_duration_BEATLES_LET_IT_BE[SONG_LEN_BEATLES_LET_IT_BE] = {
...
#define SONG_VEL_CANTINA 250
    int notes_pitch_CANTINA[SONG_LEN_CANTINA] = {
    ...
    int notes_duration_CANTINA[SONG_LEN_CANTINA] = {
...
#define SONG_VEL_SWEND 225
    int notes_pitch_SWEND[SONG_LEN_SWEND] = {
        C5, F5, G5, GX5, AX5, GX5, C5, C5, F5, G5, GX5, C5, GX5, C5, C6, AX5, C5, F5, G5, GX5, F5, C6, GX5, F6, F5, GX5, G5, F5, C6, C6, GX5, F5, C5, C5, C5, C5, F5, F5, F5, F5, F5};
    int notes_duration_SWEND[SONG_LEN_SWEND] = {
        64, 128, 64, 16, 16, 128, 64, 32, 64, 32, 32, 32, 16, 16, 16, 128, 64, 64, 32, 32, 16, 32, 16, 128, 64, 16, 16, 16, 64, 16, 16, 16, 64, 16, 16, 16, 64, 16, 16, 16, 64};

#define SONG_EUROPE_ORDER 38
#define SONG_LEN_EUROPE 97
#define SONG_VEL_EUROPE 140
    int notes_pitch_EUROPE[SONG_LEN_EUROPE] = {
    ...
    int notes_duration_EUROPE[SONG_LEN_EUROPE] = {
...
#define SONG_VEL_BARBIEGIRL 125
    int notes_pitch_BARBIEGIRL[SONG_LEN_BARBIEGIRL] = {
        GX5, E5, GX5, CX6, A5, R, FX5, DX5, FX5, B5, GX5, FX5, E5, R, E5, CX5, FX5, CX5, R, FX5, E5, GX5, FX5};
    int notes_duration_BARBIEGIRL[SONG_LEN_BARBIEGIRL] = {
...
#define SONG_VEL_FUNKYTOWN 125
    int notes_pitch_FUNKYTOWN[SONG_LEN_FUNKYTOWN] = {
        C6, C6, AX5, C6, R, G5, R, G5, C6, F6, E6, C6, R, C6, C6, AX5, C6, R, G5, R, G5, C6, F6, E6, C6};
    int notes_duration_FUNKYTOWN[SONG_LEN_FUNKYTOWN] = {
...
#define SONG_VEL_LET_IT_BE 100
    int notes_pitch_LET_IT_BE[SONG_LEN_LET_IT_BE] = {
        E6, D6, C6, E6, G6, A6, G6, G6, G6, E6, D6, C6, A5, G5, E6, R, E6, E6, F6, E6, E6, D6, R, E6, D6, D6, C6};
    int notes_duration_LET_IT_BE[SONG_LEN_LET_IT_BE] = {
        8, 16, 32, 8, 16, 16, 16, 8, 16, 16, 8, 16, 8, 16, 32, 32, 16, 8, 16, 16, 16, 16, 8, 8, 8, 16, 64};

#define SONG_INDIANAJONES_ORDER 42
#define SONG_LEN_INDIANAJONES 55
#define SONG_VEL_INDIANAJONES 250
    int notes_pitch_INDIANAJONES[SONG_LEN_INDIANAJONES] = {
    ...
    int notes_duration_INDIANAJONES[SONG_LEN_INDIANAJONES] = {
...
#define SONG_VEL_BOLERO 80
    int notes_pitch_BOLERO[SONG_LEN_BOLERO] = {
    ...
    int notes_duration_BOLERO[SONG_LEN_BOLERO] = {
...
#define SONG_VEL_XFILES 125
    int notes_pitch_XFILES[SONG_LEN_XFILES] = {
    ...
    int notes_duration_XFILES[SONG_LEN_XFILES] = {
