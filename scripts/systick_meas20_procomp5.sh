...
# mappings
sed -i 's/^.*mapping vel normal/750, 750, 760 \/\/ mapping vel normal/' ../src/mightybug_a/fsm.c 

sed -i 's/^.*mapping vel turbo/650, 675, 675 \/\/ mapping vel turbo/' ../src/mightybug_a/fsm.c 
...
sed -i 's/#define STEP_NORMAL_QTY_INC.*/#define STEP_NORMAL_QTY_INC 2/' ../src/mightybug_a/fsm.h 
