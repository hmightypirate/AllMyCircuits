...
# mappings
sed -i 's/^.*mapping vel normal/675, 675, 700 \/\/ mapping vel normal/' ../src/mightybug_a/fsm.c 

sed -i 's/^.*mapping vel turbo/550, 575, 550 \/\/ mapping vel turbo/' ../src/mightybug_a/fsm.c 
...
sed -i 's/#define STEP_NORMAL_QTY_INC.*/#define STEP_NORMAL_QTY_INC 6/' ../src/mightybug_a/fsm.h 
