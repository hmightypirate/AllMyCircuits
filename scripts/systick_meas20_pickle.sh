...
# mappings
sed -i 's/^.*mapping vel normal/480, 580, 625 \/\/ mapping vel normal/' ../src/mightybug_a/fsm.c 

sed -i 's/^.*mapping vel turbo/460, 480, 480 \/\/ mapping vel turbo/' ../src/mightybug_a/fsm.c 
