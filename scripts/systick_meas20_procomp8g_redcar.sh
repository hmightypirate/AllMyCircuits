...
# mappings
sed -i 's/^.*mapping vel normal/775, 800, 825 \/\/ mapping vel normal/' ../src/mightybug_a/fsm.c 

sed -i 's/^.*mapping vel turbo/675, 725, 775 \/\/ mapping vel turbo/' ../src/mightybug_a/fsm.c 
...
sed -i 's/^.*pickle 512 to 736/68,72,76,80,84,88,92,96, \/\/ pickle 512 to 736/' ../src/mightybug_a/motors.c 

sed -i 's/^.*pickle 768 to 992/100,104,108,112,116,120,124,128,132,  \/\/ pickle 768 to 992/' ../src/mightybug_a/motors.c 
...
sed -i 's/#define STEP_NORMAL_QTY_DEC.*/#define STEP_NORMAL_QTY_DEC 50/' ../src/mightybug_a/fsm.h

sed -i 's/#define STEP_NORMAL_QTY_INC.*/#define STEP_NORMAL_QTY_INC 30/' ../src/mightybug_a/fsm.h 
...
sed -i 's/#define MAX_VEL_DELAY_STEP_UP.*$/#define MAX_VEL_DELAY_STEP_UP  160/' ../src/mightybug_a/fsm.h

# stop out of line
sed -i 's/#define FLAG_DELAY_STOP_OUT_OF_LINE.*$/#define FLAG_DELAY_STOP_OUT_OF_LINE 0/' ../src/mightybug_a/fsm.h
sed -i 's/#define MS_DELAY_OUT_OF_LINE.*$/#define MS_DELAY_OUT_OF_LINE 300 \/\/ ms/' ../src/mightybug_a/fsm.h
