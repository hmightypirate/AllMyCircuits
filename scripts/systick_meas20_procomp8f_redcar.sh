...
sed -i 's/#define STEP_NORMAL_QTY_INC.*/#define STEP_NORMAL_QTY_INC 25/' ../src/mightybug_a/fsm.h 
...
sed -i 's/#define MAX_VEL_DELAY_STEP_UP.*$/#define MAX_VEL_DELAY_STEP_UP  150/' ../src/mightybug_a/fsm.h
