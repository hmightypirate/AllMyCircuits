...
# mappings
sed -i 's/^.*mapping vel normal/650, 725, 800 \/\/ mapping vel normal/' ../src/mightybug_a/fsm.c 

sed -i 's/^.*mapping vel turbo/600, 650, 700 \/\/ mapping vel turbo/' ../src/mightybug_a/fsm.c 
