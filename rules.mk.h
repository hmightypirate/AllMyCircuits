CROSS_COMPILE = /home/hector/GUI_linefollower/gcc-arm-none-eabi-7-2018-q2-update/bin/arm-none-eabi-
...
CFLAGS = -Wall -Wextra -g3 -O2 -Os -MD $(CPUFLAGS) -DSTM32F1 -std=c99 $(PILLFLAGS) -I${OPENCM3_DIR}/include
